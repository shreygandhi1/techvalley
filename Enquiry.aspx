<%@ Page Title="" Language="C#" MasterPageFile="~/techvalley.master" AutoEventWireup="true" CodeFile="Enquiry.aspx.cs" Inherits="Enquiry" %>
					...
					<div class="wrapper">
						<div class="row no-gutters justify-content-between">
				        	...
				        	<div class="dbox w-100 d-flex align-items-start">
				        		...
				        		<div class="text pl-4">
					            <p><span>Phone:</span> <a href="tel://9510312325">+91 9510312325</a></p>
					          </div>
				          </div>
				        	<div class="dbox w-100 d-flex align-items-start">
				        		<div class="icon d-flex align-items-center justify-content-center">
				        		...
				        		<div class="text pl-4">
					            <p><span>Email:</span> <a href="mailto:info@yoursite.com">gshrey470@gamil.com</a></p>
					          </div>
				          </div>
				        	<div class="dbox w-100 d-flex align-items-start">
				        		<div class="icon d-flex align-items-center justify-content-center">
				        		...
				        		<div class="text pl-4">
					            <p><span>Website</span> <a href="#">techvalley.com</a></p>
					          </div>
				          </div>
			          </div>
							</div>
				            ...
				            Your message was sent, thank you!
										...
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group">
													<asp:TextBox runat="server" ID="txtMessage" CssClass="form-control" placeholder="Message" Height="10em"  />
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
